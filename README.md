...
This plugin runs in the wawk Wasm sandbox. It has no network access, no filesystem access, and no ability to execute system commands. See the wawk-rs SECURITY.md for details on the sandbox architecture.
